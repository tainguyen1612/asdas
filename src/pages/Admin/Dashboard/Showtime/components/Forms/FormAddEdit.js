...
import { createShowtime, updateShowtime } from '../../../../../../redux/actions/showtimeActions';
      ...
      <Row>
        <Col>
          <Form.Group>
            ...
            <Form.Select
              defaultValue={
                showtime?.Cinema.cineplex_id ? showtime?.Cinema?.cineplex_id : currentCineplexId
              }
        ...
        <Col>
          <Form.Group>
            <Form.Label className="form-group required control-label">Date Time Start</Form.Label>
            <Form.Control
              type="datetime-local"
              {...register('start_time')}
              defaultValue={
                showtime?.start_time ? moment(showtime?.start_time).format('YYYY-MM-DDTHH:mm') : ''
              }
