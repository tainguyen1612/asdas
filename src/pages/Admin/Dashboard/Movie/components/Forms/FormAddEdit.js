    ...
    <Form
      ...
      <Row>
        ...
        <Col>
          ...
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Description</Form.Label>
            <Form.Control
              as="textarea"
              type="text"
          ...
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Director</Form.Label>
            <Form.Control
              type="text"
          ...
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Release Date</Form.Label>
          ...
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Running Time</Form.Label>
            <Form.Control
              type="number"
              min="0"
