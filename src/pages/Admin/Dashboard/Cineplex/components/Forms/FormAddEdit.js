...
import { createCineplex, updateCineplex } from '../../../../../../redux/actions/cineplexActions';
    ...
    <Form
      ...
      <Row>
        ...
        <Col>
          ...
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Google Map URL</Form.Label>
            <Form.Control
              type="text"
