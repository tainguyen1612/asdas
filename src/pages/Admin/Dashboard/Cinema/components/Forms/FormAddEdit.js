  ...
  return (
    <Form
      ...
      <Row>
        <Col>
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Vertical Size</Form.Label>
            <Form.Control
              type="number"
              min="1"
              id="vertical"
        ...
        <Col>
          <Form.Group className="mt-3">
            <Form.Label className="form-group required control-label">Horizontal Size</Form.Label>
            <Form.Control
              type="number"
              min="1"
              id="horizontal"
